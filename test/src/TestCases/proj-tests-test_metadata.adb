...
package body PROJ.Tests.test_metadata is
   use AUnit;
   ...
   procedure metadata_citation (Test : in out AUnit.Test_Cases.Test_Case'Class) is
   begin
      null;
...
--  ASSERT_EQ(*(c2.title()), "my citation");      
   end metadata_citation;

   procedure metadata_extent (Test : in out AUnit.Test_Cases.Test_Case'Class) is
   begin
      null;
--  Extent::create(
...
--  Extent::createFromBBOX(-180.0, -60.0, -170.0, -25.0)));      
   ...
   procedure metadata_identifier_empty (Test : in out AUnit.Test_Cases.Test_Case'Class) is
   begin
      null;
...
--  ASSERT_TRUE(!id2.description().has_value());      
   end metadata_identifier_empty;

   procedure metadata_identifier_properties (Test : in out AUnit.Test_Cases.Test_Case'Class) is
   begin
      null;
...
--  ASSERT_EQ(*(id2.description()), "description");      
   end metadata_identifier_properties;

   procedure metadata_identifier_code_integer (Test : in out AUnit.Test_Cases.Test_Case'Class) is
   begin
      null;
--  PropertyMap properties;
...
--  ASSERT_EQ(id->code(), "1234");      
   end metadata_identifier_code_integer;

   procedure metadata_identifier_code_string (Test : in out AUnit.Test_Cases.Test_Case'Class) is
   begin
      null;
--  PropertyMap properties;
--  properties.set(Identifier::CODE_KEY, "1234");
--  auto id(Identifier::create(std::string(), properties));
--  ASSERT_EQ(id->code(), "1234");      
   end metadata_identifier_code_string;

   procedure metadata_identifier_code_invalid_type (Test : in out AUnit.Test_Cases.Test_Case'Class) is
   begin
      null;
--  PropertyMap properties;
...
--  InvalidValueTypeException);      
   end metadata_identifier_code_invalid_type;

   procedure metadata_identifier_authority_citation (Test : in out AUnit.Test_Cases.Test_Case'Class) is
   begin
      null;
--  PropertyMap properties;
...
--  ASSERT_EQ(*(id->authority()->title()), "authority");      
   end metadata_identifier_authority_citation;

   procedure metadata_identifier_authority_invalid_type (Test : in out AUnit.Test_Cases.Test_Case'Class) is
   begin
      null;
--  PropertyMap properties;
...
--  ASSERT_THROW(Identifier::create(std::string(), properties),
--  InvalidValueTypeException);      
   end metadata_identifier_authority_invalid_type;

   procedure metadata_id (Test : in out AUnit.Test_Cases.Test_Case'Class) is
   begin
      null;
...
--  EXPECT_EQ(got_wkt, in_wkt);      
   ...
   procedure metadata_Identifier_isEquivalentName (Test : in out AUnit.Test_Cases.Test_Case'Class) is
   begin
      null;
...
--  EXPECT_TRUE(Identifier::isEquivalentName("\xc3\xa4", "\xc3\xa1"));      
   end metadata_Identifier_isEquivalentName;
   
   procedure Register_Tests (Test : in out Test_Case) is
   begin
      null;
      Registration.Register_Routine (Test, metadata_citation'Access, "metadata_citation");

      Registration.Register_Routine (Test, metadata_extent'Access, "metadata_extent");

      Registration.Register_Routine (Test, metadata_identifier_empty'Access, "metadata_identifier_empty");

      Registration.Register_Routine (Test, metadata_identifier_properties'Access, "metadata_identifier_properties");

      Registration.Register_Routine (Test, metadata_identifier_code_integer'Access, "metadata_identifier_code_integer");

      Registration.Register_Routine (Test, metadata_identifier_code_string'Access, "metadata_identifier_code_string");

      Registration.Register_Routine (Test, metadata_identifier_code_invalid_type'Access, "metadata_identifier_code_invalid_type");

      Registration.Register_Routine (Test, metadata_identifier_authority_citation'Access, "metadata_identifier_authority_citation");

      Registration.Register_Routine (Test, metadata_identifier_authority_invalid_type'Access, "metadata_identifier_authority_invalid_type");

      Registration.Register_Routine (Test, metadata_id'Access, "metadata_id");

      Registration.Register_Routine (Test, metadata_Identifier_isEquivalentName'Access, "metadata_Identifier_isEquivalentName");

   end Register_Tests;

end PROJ.Tests.test_metadata;